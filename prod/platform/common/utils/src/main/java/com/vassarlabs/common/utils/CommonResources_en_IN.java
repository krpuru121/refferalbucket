...
public class CommonResources_en_IN extends ListResourceBundle{
	...
	public Map<String, IMessageObject> getI8nErrors()
	{
		...
		IMessageObject err_11111 = new WarningObject(11111, "Exception occured","Unexpected Exception Error");
		errors.put("11111", err_11111);
